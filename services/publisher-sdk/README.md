...
The SDK only ever sends the domain, route slug, and proof-of-payment/verification to the Verivyx API — the content body stays on your server (authorize-only model).
